 ...
 */
@Database(entities = [Fence::class, Route::class, Location::class, EventLog::class  ], version = 2, exportSchema = false)
    ...
    companion object {
        ...
        fun getDatabase(context: Context): GeoDatabase {
            ...
            return Instance ?: synchronized(this) {
                Room.databaseBuilder(context, GeoDatabase::class.java, "geo_database")
                    /**
